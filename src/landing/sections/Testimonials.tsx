...
export const Testimonials: React.FC = () => {
  ...
  return (
    <section className="py-20 bg-purple-50/10 rounded-[2.5rem] border border-purple-100/30 px-6">
      <div className="max-w-4xl mx-auto space-y-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-left">
          {reviews.map((rev, idx) => (
            <div key={idx} className="bg-white p-8 rounded-2xl border border-purple-100/50 space-y-4 shadow-xs">
