    ...
    <div className="flex-1 flex flex-col bg-white h-full overflow-y-auto no-scrollbar pb-24">
      ...
      <div className="px-4 mt-4">
        ...
        >
          ...
          <motion.div
            ...
            className="p-3 bg-white border border-slate-100 hover:border-green-300 shadow-md hover:shadow-xl rounded-xl flex items-center justify-between cursor-pointer transition-all duration-200"
          >
            <div className="flex items-center gap-2.5">
              <div className="w-9 h-9 rounded-xl bg-green-600 text-white flex items-center justify-center shrink-0 shadow-lg">
          ...
          <motion.div
            ...
            className="p-3 bg-white border border-slate-100 hover:border-orange-300 shadow-md hover:shadow-xl rounded-xl flex items-center justify-between cursor-pointer transition-all duration-200"
          >
            <div className="flex items-center gap-2.5">
              <div className="w-9 h-9 rounded-xl bg-orange-500 text-white flex items-center justify-center shrink-0 shadow-lg">
          ...
          <motion.div
            ...
            className="p-3 bg-white border border-slate-100 hover:border-blue-300 shadow-md hover:shadow-xl rounded-xl flex items-center justify-between cursor-pointer transition-all duration-200"
          >
            <div className="flex items-center gap-2.5">
              <div className="w-9 h-9 rounded-xl bg-blue-600 text-white flex items-center justify-center shrink-0 shadow-lg">
          ...
          <motion.div
            ...
            whileHover={{ y: -2, scale: 1.01 }}
            onClick={() => onNavigateTab('trade')}
            className="p-3 bg-white border border-slate-100 hover:border-yellow-300 shadow-md hover:shadow-xl rounded-xl flex items-center justify-between cursor-pointer transition-all duration-200"
          >
            <div className="flex items-center gap-2.5">
              <div className="w-9 h-9 rounded-xl bg-yellow-500 text-white flex items-center justify-center shrink-0 shadow-lg">
      ...
      >
        <motion.div
          ...
          className="bg-purple-600 text-white rounded-xl px-4 py-3 flex items-center justify-between cursor-pointer relative overflow-hidden shadow-lg hover:shadow-xl transition-shadow"
        >
      ...
      >
        ...
        <div className="grid grid-cols-4 gap-2 text-center">
          ...
          >
            <div className="w-11 h-11 rounded-xl bg-purple-50 border border-purple-100 text-purple-600 flex items-center justify-center shadow-md group-hover:shadow-xl group-hover:bg-purple-100 transition-all">
        ...
        >
          {trendingProducts.map((prod) => (
            <motion.div 
              ...
              whileHover={{ y: -2 }}
              onClick={() => onNavigateTab('market')}
              className="bg-white border border-slate-100 rounded-xl overflow-hidden shadow-md hover:shadow-xl cursor-pointer flex flex-col justify-between transition-shadow"
            >
      ...
      {onNavigateToLanding && (
        <div className="px-4 mt-4">
          <button 
            ...
            className="w-full py-3 bg-slate-900 hover:bg-slate-800 text-white font-sans font-bold text-xs rounded-xl shadow-lg hover:shadow-xl transition-all flex items-center justify-center gap-1.5 cursor-pointer"
          >
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/50 backdrop-blur-xs">
            ...
            >
              ...
              <div className="space-y-3 mt-4">
                ...
                >
                  <div className={`p-2 rounded-xl shrink-0 shadow-sm ${activeProfile.role === 'buyer' ? 'bg-purple-600 text-white' : 'bg-slate-100 text-slate-500'}`}>
                ...
                >
                  <div className={`p-2 rounded-xl shrink-0 shadow-sm ${activeProfile.role === 'seller' ? 'bg-purple-600 text-white' : 'bg-slate-100 text-slate-500'}`}>
                    <Store className="w-4 h-4" />
                  </div>
                  <div>
        ...
        {referModalOpen && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/50 backdrop-blur-xs">
            ...
            >
              ...
              <div className="w-16 h-16 rounded-full bg-purple-50 text-purple-600 flex items-center justify-center mx-auto shadow-lg">
              ...
              <button
                ...
                className="w-full py-2.5 bg-purple-600 hover:bg-purple-700 text-white font-sans font-bold text-xs rounded-xl shadow-lg hover:shadow-xl transition-all cursor-pointer"
              >
                Copy & Share Link
              </button>
            </motion.div>
